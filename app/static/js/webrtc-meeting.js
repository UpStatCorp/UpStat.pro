...
class WebRTCMeetingClient {
    ...
    updateMuteButton() {
        if (this.muteButton) {
            const micOn = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>';
            ...
            this.muteButton.innerHTML = this.isMuted ? micOff : micOn;
    ...
    updateVideoButton() {
        if (this.videoButton) {
            const videoOn = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>';
            const videoOff = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m5.66 0H14a2 2 0 0 1 2 2v3.34l1 1L23 7v10"/><line x1="1" y1="1" x2="23" y2="23"/></svg>';
            this.videoButton.innerHTML = this.isVideoEnabled ? videoOn : videoOff;
    ...
    updateAIAgentButton() {
        if (this.aiAgentButton) {
            const aiIcon = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:6px"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>';
            if (this.aiAgentActive) {
                this.aiAgentButton.innerHTML = aiIcon + 'AI активен';
                this.aiAgentButton.disabled = true;
                this.aiAgentButton.className = 'control-btn ai-btn active';
            } else {
                this.aiAgentButton.innerHTML = aiIcon + 'Запустить ИИ';
